...
def nifti_to_png(nifti_path, output_dir, patient_id):
    ...
    for z in range(img.shape[2]):
        ...
        colored_image = colored_image.transpose(Image.FLIP_LEFT_RIGHT)  # Flip horizontally
...
def nifti_to_contour_png(nifti_path, output_dir, patient_id, contour_thickness=1):
    ...
    for z in range(img.shape[2]):
        ...
        contour_image_pil = contour_image_pil.transpose(Image.FLIP_LEFT_RIGHT)  # Flip horizontally
