...
def export_to_nifti_and_png():
    ...
    base_output_dir = r"file/path/to/output/directory"  # Change this to your desired output directory
    output_dir = os.path.join(base_output_dir, f"{patient_id}_ExtractedData")
    os.makedirs(output_dir, exist_ok=True)
    mask_nifti_path = os.path.join(output_dir, f"{patient_id}_Nifty.nii.gz")
